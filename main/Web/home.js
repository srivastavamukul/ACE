...
import ASCIIShader from './assets/shaders/ASCII.js';
...
const backgroundImage = textureLoader.load('./assets/visualizer.webp');
...
const tFont = fontLoader.load('./assets/font.png')
...
window.addEventListener("mousemove", event => {
  let xMove = ( event.clientX / window.innerWidth ) * 2 - 1; // from the docs of Raycaster
    ...
    modelContainer.rotation.y = xMove * Math.PI * 0.2;
